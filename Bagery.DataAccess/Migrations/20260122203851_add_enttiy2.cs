...
{
    /// <inheritdoc />
    public partial class add_enttiy2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Overview1 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Overview2 = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Overview3 = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ThreeStepServiceId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IconUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Title = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ThreeStepServices", x => x.ThreeStepServiceId);
                });
